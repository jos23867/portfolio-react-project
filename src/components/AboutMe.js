    ...
    <div id="about" className="container py-5">
      <div className="row">
        ...
        <div className="col-lg-6 col-xm-12">
          ...
          <p>
            Hello! I am Jose. I have been developing skills to build websites for over 6 months. 
            I'd like to be a Full-Stack Web Developer and I am working on it.
            
            Technologies I would like to use is MERN(MongoDB, Express, ReactJS and NodeJS).

            I will create responsive websites that are displayed on all devices desktops and smartphones.
